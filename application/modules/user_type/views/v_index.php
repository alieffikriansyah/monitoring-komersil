                           ...
                           <div class="row" id="export">
                              ...
                              <table class="table table-condensed table-striped table-bordered" id="tabel-data">
                                 <thead class="thead-blue">
                                    <tr>
                                       <th class="cemter-t">Jenis User</th>
          ...
          <form onsubmit="return SaveGroup(this)">
             <div class="modal-body">
                <div class="form-group row">
                   ...
                   <div class="col-sm-6">
                      <input type="text" class="form-control" name="name_role" id="name_role" required>
                   </div>
                </div>
...
<script>
   ...
   var end = "";
      ...
      function FilterData(){
         ...
         $.ajax({
               url: "<?=base_url()?>User_type/LoadData",
               type: 'post',
               // data: formData,
               contentType: false,
               processData: false,
               ...
               success: function(r){
                  ...
                  jQuery.each(json, function( i, val ) {
                     ...
                     header_table +=`<tr >
                                       ...
                                       <td class="center">`+val['name_role']+`</td>
                                       ...
                                       <td class="center">
                                          ...
                                          <button class="btn waves-effect waves-light btn-danger btn-icon" onclick="confirmDelete(`+val['id']+`, '` + val['nama_masalah'] + `')"><i class="fa fa-trash"></i></button>
      ...
      function MenuParent(){
         $.ajax({
               url: "<?=base_url()?>user_type/LoadDataParent",
               type: 'post',
               // data: formData,
               contentType: false,
               processData: false,
    ...
    function EditData(id){
      ...
      $.ajax({
               url: "<?=base_url()?>User_type/EditData/"+id,
               type: 'post',
               // data: formData,
               contentType: false,
               processData: false,
               ...
               success: function(r){
                  MenuParent();
                  var json = JSON.parse(r);
                  $('#name_role').val(json['name_role']);  
               
                  console.log(json['name_role']);  
    ...
    function Delete(id){
      ...
      // MenuParent();
      $.ajax({
         url:  '<?=base_url('user_type/')?>Delete/'+id,
    ...
    function UpdateData(f,id){
      ...
      $.ajax({
         url:  '<?=base_url('user_type/')?>Update/'+id,
   ...
   function SaveData(f){
      ...
      // formData.append('id', id);
      $.ajax({
         url:  '<?=base_url('User_type/')?>SaveData/',
